...
import com.fasa.runtracker.databinding.FragmentTrackingBinding
import com.fasa.runtracker.model.Run
import com.fasa.runtracker.service.Polyline
import com.fasa.runtracker.service.TrackingService
...
import com.fasa.runtracker.util.Constants.CANCEL_TRACKING_DIALOG_TAG
import com.fasa.runtracker.util.Constants.MAP_ZOOM
...
class TrackingFragment : Fragment() {
    ...
    private fun subscribeToObservers() {
        ...
        TrackingService.timeRunInMillis.observe(viewLifecycleOwner, Observer {
            ...
            val formattedTime = TrackingUtil.getFormattedStopWatchTime(it, true)
